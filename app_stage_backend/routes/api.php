...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Admin Only (User Management and Sessions)
    ...
    // Read-only access for all roles (to populate dropdowns)
    ...
    // Logistics Operations (Manager & Employé Only)
